# An example of LLaVA 1.5 7B generate - divide and conquer - MiniCPM-Llama3-V 2.5 feedback
...
minicpmv_python=/home/jeeves/miniconda3/envs/minicpmv25/bin/python # Your MiniCPM-V python path
...
-1 \
$minicpmv_python \
1 # chunk num, equal to the gpus available
...
feedback_file=autocheck_minicpmv25.s0-e-1.diverse_gen_llava15_${start}-${end}_${ques_file}.s0-e-1.llama3-8b_divide.gq.qas.jsonl # name of the feedback result file
...
pairs_file=autocheck_minicpmv25.s0-e-1.diverse_gen_llava15_${start}-${end}_${ques_file}.s0-e-1.llama3-8b_divide.gq.qas_pair_diff1_samp2.jsonl
balanced_pairs_file=autocheck_minicpmv25.s0-e-1.diverse_gen_llava15_${start}-${end}_${ques_file}.s0-e-1.llama3-8b_divide.gq.qas_pair_diff1_samp2_balanceshort.jsonl
